...
# WARNING! I had to create this by manually updating a pyuic5 version to QT6 compatibility, because the pyuic6 version incorrectly scaled the button images!
...
class Ui_CoverageBuilder(object):
    def setupUi(self, CoverageBuilder):
        ...
        CoverageBuilder.setWindowModality(QtCore.Qt.WindowModality.NonModal)
        CoverageBuilder.resize(501, 460)
        CoverageBuilder.setFocusPolicy(QtCore.Qt.FocusPolicy.NoFocus)
        self.buttonBox = QtWidgets.QDialogButtonBox(CoverageBuilder)
        self.buttonBox.setGeometry(QtCore.QRect(150, 410, 201, 32))
        ...
        self.lblGrille.setFrameShape(QtWidgets.QFrame.Shape.Box)
        self.lblGrille.setFrameShadow(QtWidgets.QFrame.Shadow.Sunken)
        ...
        self.gridLayoutWidget.setGeometry(QtCore.QRect(30, 200, 441, 150))
        ...
        self.lblDyn.setFrameShape(QtWidgets.QFrame.Shape.Box)
        self.lblDyn.setFrameShadow(QtWidgets.QFrame.Shadow.Sunken)
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/plugins/coveragebuilder/icon.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.lblEntete.setTextFormat(QtCore.Qt.TextFormat.AutoText)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/plugins/coveragebuilder/about.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
