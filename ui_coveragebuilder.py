...
class Ui_CoverageBuilder(object):
    def setupUi(self, CoverageBuilder):
        CoverageBuilder.setObjectName(_fromUtf8("CoverageBuilder"))
        ...
        self.lblGrille.setPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/coveragebuilder/grille.png")))
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/coveragebuilder/refresh.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.lblDyn.setPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/coveragebuilder/grille_dyn.png")))
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/coveragebuilder/icon.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/coveragebuilder/about.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.buttonBox.rejected.connect(CoverageBuilder.accept)
#        QtCore.QObject.connect(self.buttonBox, QtCore.SIGNAL(_fromUtf8("accepted()")), CoverageBuilder.accept)
#        QtCore.QObject.connect(self.buttonBox, QtCore.SIGNAL(_fromUtf8("rejected()")), CoverageBuilder.reject)
        QtCore.QMetaObject.connectSlotsByName(CoverageBuilder)

    def retranslateUi(self, CoverageBuilder):
        CoverageBuilder.setWindowTitle(QtWidgets.QApplication.translate("CoverageBuilder", "Grids for Atlas", None))
        self.lblComp.setText(QtWidgets.QApplication.translate("CoverageBuilder", "Layout :", None))
        self.lblOverlap.setText(QtWidgets.QApplication.translate("CoverageBuilder", "Overlap %:", None))
        self.lblOutDir.setText(QtWidgets.QApplication.translate("CoverageBuilder", "Outfiles\n"
"directory :", None))
        self.btnUpdate.setText(QtWidgets.QApplication.translate("CoverageBuilder", "...", None))
        self.btnShow.setText(QtWidgets.QApplication.translate("CoverageBuilder", "Show", None))
        self.btnBrowse.setText(QtWidgets.QApplication.translate("CoverageBuilder", "Browse"))
        self.lblInLayer.setText(QtWidgets.QApplication.translate("CoverageBuilder", "Coverage\n"
"layer :", None))
        self.btnCreerSyno.setText(QtWidgets.QApplication.translate("CoverageBuilder", "Create coverage layer(s)", None))
        self.chkGrille.setText(QtWidgets.QApplication.translate("CoverageBuilder", "Generate regular coverage layer"))
        self.chkDyn.setText(QtWidgets.QApplication.translate("CoverageBuilder", "Generate irregular coverage layer"))
        self.aboutButton.setText(QtWidgets.QApplication.translate("CoverageBuilder", "...", None))
        self.lblEntete.setText(QtWidgets.QApplication.translate("CoverageBuilder", "Coverage Builder"))
        self.helpButton.setText(QtWidgets.QApplication.translate("CoverageBuilder", "...", None))
